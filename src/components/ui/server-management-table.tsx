...
export function ServerManagementTable({
  ...
  // Safe assuming dark since this is an admin panel component requesting dark mode
  ...
  const getCPUBars = (percentage: number, status: Server["status"]) => {
    ...
    const getBarColor = (index: number) => {
      if (index >= filledBars) {
        return "bg-gray-800 border border-white/10";
      }
  ...
  return (
    <div className={`w-full max-w-7xl mx-auto ${className}`}>
      <div className="relative border border-white/10 rounded-2xl p-6 bg-black/40 backdrop-blur-3xl shadow-2xl">
        {/* Header */}
            ...
            >
              ...
              >
                ...
                <div className="relative grid grid-cols-12 gap-4 items-center">
                  ...
                  {/* Service Location */}
                  <div className="col-span-2 flex items-center gap-3">
                    <div className="w-8 h-8 rounded-full overflow-hidden border border-white/10 flex items-center justify-center">
        ...
        <AnimatePresence>
          {selectedServer && (
            <motion.div
              ...
              className="absolute inset-0 bg-black/80 backdrop-blur-md flex flex-col rounded-2xl z-10 overflow-hidden"
            >
              {/* Header with Actions */}
              <div className="relative bg-gradient-to-r from-gray-900 to-transparent p-4 border-b border-white/10 flex items-center justify-between">
                <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  {/* Close Button */}
                  <motion.button
                    className="w-8 h-8 bg-gray-800 hover:bg-gray-700 rounded-full flex items-center justify-center border border-white/20 ml-2"
              ...
              <div className="flex-1 p-4 space-y-4 overflow-y-auto">
                ...
                <div className="bg-white/5 rounded-lg p-3 border border-white/10">
                  ...
                  <div className="font-mono text-xs space-y-1 max-h-24 overflow-y-auto">
                    ...
                    <div className="text-gray-400">[15:40:05] Connection from {selectedServer.ip}</div>
                  </div>
                </div>
              </div>
            </motion.div>
