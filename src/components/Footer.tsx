...
export default function Footer() {
  ...
  return (
    <footer className="bg-primary dark:bg-black/80 text-white pt-32 pb-16 relative overflow-hidden">
      {/* Visual accents */}
      ...
      <div className="container-custom relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 mb-24">
          ...
          <div className="space-y-8">
            ...
            <p className="text-gray-400 text-sm font-bold uppercase tracking-tight leading-relaxed opacity-70">
            ...
            <div className="flex gap-4">
              {[Linkedin, Facebook, Twitter].map((Icon, i) => (
                <a
                  key={i}
                  href="#"
                  className="w-12 h-12 rounded-xl bg-white/5 border border-white/10 flex items-center justify-center hover:bg-accent hover:border-accent transition-all duration-300 shadow-xl"
                >
                  <Icon size={20} />
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-6 text-xs text-gray-400 font-bold uppercase tracking-widest">
          ...
          {/* Registration */}
          <div className="liquid-glass p-8 rounded-[40px] border border-white/10 space-y-8 bg-white/5 shadow-2xl">
            <div className="flex items-center gap-4">
              <div className="w-10 h-10 bg-accent/20 rounded-xl flex items-center justify-center text-accent">
                <ShieldCheck size={24} />
              </div>
              <h4 className="font-black text-white uppercase tracking-tighter">FBR Certified</h4>
            </div>
            <p className="text-[10px] text-gray-500 leading-relaxed font-black uppercase tracking-widest opacity-60">
            ...
            <div className="pt-2">
              ...
              <div className="bg-black/40 border border-white/10 px-4 py-3 rounded-xl font-mono text-xs font-black tracking-widest text-center shadow-inner text-white">
        ...
        <div className="pt-16 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8 text-[10px] font-black uppercase tracking-[0.2em] text-gray-600">
